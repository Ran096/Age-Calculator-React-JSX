...
function App() {
	...
	return (
		<div className="flex flex-col justify-center items-center w-screen h-screen bg-cyan-900">
			<div className="md:w-2/5 w-10/12">
				<h1 className="text-white text-3xl text-center mb-3 font-sans font-semibold">Age Calculator React JSX</h1>
